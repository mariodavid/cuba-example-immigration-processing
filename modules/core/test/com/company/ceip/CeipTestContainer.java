...
public class CeipTestContainer extends TestContainer {

    public CeipTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/ceip/app.properties",
    ...
    public static class Common extends CeipTestContainer {

        public static final CeipTestContainer.Common INSTANCE = new CeipTestContainer.Common();
